...
const sections = [
  ...
  },
  {
    title: "6. 쿠키 사용",
    content:
      "DESTINO는 야간 모드 설정, 언어 선택 등 기능적 목적으로만 쿠키 및 로컬 스토리지를 사용합니다. 광고 추적 목적의 쿠키는 사용하지 않습니다. 서비스 개선을 위한 익명화된 분석 도구(Google Analytics)를 사용할 수 있으며, 이 경우 개인을 식별할 수 없는 통계 정보만 수집됩니다.",
  },
  {
    title: "7. 개인정보 보호책임자",
    content:
